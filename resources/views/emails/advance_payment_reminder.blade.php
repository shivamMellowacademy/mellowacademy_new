        ...
        <div class="content">
            ...
            <div class="payment-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="payment-difference">
                        {{ number_format($employee->current_ctc ?? 0, 2) }} {{ config('app.currency', 'IND') }}
                    </span>
                </div>
                 <div class="detail-row">
                    <span class="detail-label">Due Amount:</span>
                    <span class="payment-difference">
                        {{ number_format($employee->current_ctc - $employee->payment_amount ?? 0, 2) }} {{ config('app.currency', 'IND') }}
                    </span>
                </div>
                 <div class="detail-row">
                    <span class="detail-label">Tax:</span>
                    <span class="payment-difference">
                        {{ number_format( (($employee->current_ctc - $employee->payment_amount) * $tax )/ 100 ?? 0, 2) }} {{ config('app.currency', 'IND') }}
                    </span>
                </div>
            </div>
